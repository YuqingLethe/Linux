...
## Your local settings
tomcat_dir="<absolute_directory>/apache-tomcat-9.0.39";
scp_project_dir="absolute_dir_to_project";
scp_target_relative_dir="target"; # this is usally used for SpringBoot
scp_war_name="scp"; # File name in the project
tomcat_war_name="scp"; # File name in tomcat webapps
